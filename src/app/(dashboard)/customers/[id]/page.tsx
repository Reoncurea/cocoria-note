      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <span className={`badge badge-${CUSTOMER_STATUS_BADGE[customer.status] ?? 'active'}`}>{customer.status}</span>
          </div>
...
function ActivityTypeBadge({ type }: { type: string }) {
  const c = ACTIVITY_TYPES[type as keyof typeof ACTIVITY_TYPES] ?? ACTIVITY_TYPES.other
  return (
